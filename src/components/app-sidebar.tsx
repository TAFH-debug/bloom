...
import { Leaf, Home, Flower2, Settings } from "lucide-react";
...
export function AppSidebar() {
  ...
  return (
    <aside className="app-chrome fixed inset-y-0 left-0 z-30 flex w-[4.5rem] flex-col border-r border-rose-200/40 bg-[linear-gradient(180deg,rgba(255,248,243,0.92)_0%,rgba(247,230,220,0.88)_45%,rgba(243,214,208,0.9)_100%)] backdrop-blur-xl md:w-56">
      ...
      <div className="relative flex h-full flex-col px-3 py-6 md:px-4">
        ...
        >
          <BloomLogo
            size={36}
            className="transition-shadow duration-300 group-hover:shadow-[0_12px_28px_-10px_rgba(190,100,120,0.65)]"
          />
